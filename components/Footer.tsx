    ...
    <footer className="border-t border-border py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a className="text-xs text-subtle" href="https://www.pexels.com/es-es/foto/ciudad-calle-autobus-bus-13784003/" target="_blank">Foto LATAM de Oscar Andres Roballo</a>
          <a className="text-xs text-subtle" href="https://www.pexels.com/es-es/foto/candado-metalico-para-asegurar-el-pestillo-de-una-puerta-37095097/" target="_blank">Foto candado de Артем Зелюткин</a>
          <a className="text-xs text-subtle" href="https://www.pexels.com/es-es/foto/dinero-monedas-brillante-efectivo-25961803/" target="_blank">Foto centavos de Iván Cauich</a>
          {/* Social icons */}
